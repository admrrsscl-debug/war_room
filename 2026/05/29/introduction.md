...
=======
# 🏛️ Introducción — Debate CV de Alta Calidad

**Cristian Iglesias Vera** necesita un **currículum vitae profesional de alta calidad** que refleje su perfil como:

- 🎓 **Docente universitario** en TEC UCT (Temuco)
  - Diseño y Desarrollo Web + IA
  - Inteligencia Artificial
  - Desarrollo y Diseño de Software
  - Desarrollo de aplicaciones móviles con Kivy
- 🏫 **Relator titular** Bootcamp Full Stack Python en Skillnest
- 💻 **Desarrollador web** con experiencia práctica
- 🤖 **Creador y orquestador de agentes de IA** (Newen, Antu, Hermes, Kemchi)
- 🗣️ **Integración multi-plataforma:** Telegram, Discord, War Room multi-agente

### Contexto

Se busca generar un CV que:
1. **Sea de alta calidad gráfica y de contenido** — que destaque entre reclutadores
2. **Refleje la triple faceta:** docente, desarrollador, e innovador en IA
3. **Incluya proyectos reales:** agentes de IA, plataformas educativas, bootcamps
4. **Tenga formato profesional** (ATS-friendly + versión visual)

### Objetivo del debate

Que el equipo (Newen, Antu, Hermes, Kemchi) colabore para producir un CV excelente:
- Definir **estructura y secciones**
- Elegir **formato y herramientas** (LaTeX, Canva, Figma, Word, Overleaf)
- Redactar y refinar **contenido**
- Revisar **diseño visual**
- Entregar **versión final** en PDF + editable

¡Éxito equipo! Que nos vaya bien 🚀
>>>>>>> 938e0216359e77b6fe2fd9231bd5bd5bae24b7be
